...
def processing(queue_item):
    ...
    output_type = options['output_type'] if 'output_type' in options and type(options['output_type']) is str else 'txt'
    ...
    (
        ...
        .output(audio_wav_path, ar=16000, ac=1, acodec='pcm_s16le')
    ...
    if 'saving output to' in str(result):
        ...
        if not os.path.isfile(output_file_path):
            ...
            print('out_file_path:', output_file_path)
